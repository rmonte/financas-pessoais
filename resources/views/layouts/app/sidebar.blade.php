    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky collapsible class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                ...
                <flux:sidebar.item icon="wallet" :href="route('accounts.index')" :current="request()->routeIs('accounts.index')" wire:navigate>
                    {{ __('Accounts') }}
                </flux:sidebar.item>
                ...
                <flux:sidebar.item icon="arrow-path" :href="route('recurring-transactions.index')" :current="request()->routeIs('recurring-transactions.index')" wire:navigate>
                    {{ __('Recurring') }}
                </flux:sidebar.item>
                ...
                <flux:sidebar.item icon="chart-bar" :href="route('investments.index')" :current="request()->routeIs('investments.*')" wire:navigate>
                    {{ __('Investments') }}
                </flux:sidebar.item>
            </flux:sidebar.nav>
